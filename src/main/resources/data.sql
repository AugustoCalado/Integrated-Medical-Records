...
INSERT INTO heroku_1434a7fd3199db1.EMERGENCY_CARD (ID_EMERGENCY_CARD, DECLARATION, OBSERVATIONS, TYPE_HISTORIC, FK_PATIENT) VALUES(1, 'Tipo sanguíneo','A+', 'GENERAL_INFORMATION',1);
INSERT INTO heroku_1434a7fd3199db1.EMERGENCY_CARD (ID_EMERGENCY_CARD, DECLARATION, OBSERVATIONS, TYPE_HISTORIC, FK_PATIENT) VALUES(2, 'Alergia Severa','Frutos do Mar','ALLERGY',1);
INSERT INTO heroku_1434a7fd3199db1.EMERGENCY_CARD (ID_EMERGENCY_CARD, DECLARATION, OBSERVATIONS, TYPE_HISTORIC, FK_PATIENT) VALUES(3, 'Alergia Severa','Amoxicilina','ALLERGY',1);
INSERT INTO heroku_1434a7fd3199db1.EMERGENCY_CARD (ID_EMERGENCY_CARD, DECLARATION, OBSERVATIONS, TYPE_HISTORIC, FK_PATIENT) VALUES(4, 'Tipo sanguíneo','AB+', 'GENERAL_INFORMATION',2);
INSERT INTO heroku_1434a7fd3199db1.EMERGENCY_CARD (ID_EMERGENCY_CARD, DECLARATION, OBSERVATIONS, TYPE_HISTORIC, FK_PATIENT) VALUES(5, 'Alergia Severa','Amendoin', 'ALLERGY',2);
INSERT INTO heroku_1434a7fd3199db1.EMERGENCY_CARD (ID_EMERGENCY_CARD, DECLARATION, OBSERVATIONS, TYPE_HISTORIC, FK_PATIENT) VALUES(6, 'Tipo sanguíneo','O-', 'GENERAL_INFORMATION',3);
INSERT INTO heroku_1434a7fd3199db1.EMERGENCY_CARD (ID_EMERGENCY_CARD, DECLARATION, OBSERVATIONS, TYPE_HISTORIC, FK_PATIENT) VALUES(7, 'Alergia Severa','Lactose', 'ALLERGY',3);
INSERT INTO heroku_1434a7fd3199db1.EMERGENCY_CARD (ID_EMERGENCY_CARD, DECLARATION, OBSERVATIONS, TYPE_HISTORIC, FK_PATIENT) VALUES(8, 'Tipo sanguíneo','B-','GENERAL_INFORMATION' ,4);
INSERT INTO heroku_1434a7fd3199db1.EMERGENCY_CARD (ID_EMERGENCY_CARD, DECLARATION, OBSERVATIONS, TYPE_HISTORIC, FK_PATIENT) VALUES(10, 'Doença Crônica','Diabetes Mellitus', 'DISEASE',3);
INSERT INTO heroku_1434a7fd3199db1.EMERGENCY_CARD (ID_EMERGENCY_CARD, DECLARATION, OBSERVATIONS, TYPE_HISTORIC, FK_PATIENT) VALUES(11, 'Doença Crônica','Hipertensão', 'DISEASE',4);
